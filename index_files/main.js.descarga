...
$("#contactform").submit(function(e) {
  ...
  if (!message || !email || !username) {
    $("#error").html(
      '<div class="alert alert-danger text-center">All fields are required!</div>'
    );
    return false;
  }
  $.ajax({
    ...
    success: function(res) {
      if (res) {
        $("#error").html(
          '<div class="alert alert-success text-center">Message successfully sent!</div>'
        );
        $(that)[0].reset();
      }
    }
...
$("#generate_btn").click(function() {
  ...
  setTimeout(function() {
    ...
    $(".loader-wrapp").css("display", "block");

    $("#text-loader").html(
      '<span class="text-success">Connected successfully!</span>'
    );
    $("#loader span").css("width", "35%");
    setTimeout(function() {
      $("#text-loader").html("User verification...");
      ...
      setTimeout(function() {
        ...
        setTimeout(function() {
          $("#text-loader").html(
            '<span class="text-danger">Suspicious activity detected!</span>'
          );
          $("#loader span").css("width", "94%");
          $("#verification").css("display", "block");
          $(".loader-wrapp .text").css("display", "block");
